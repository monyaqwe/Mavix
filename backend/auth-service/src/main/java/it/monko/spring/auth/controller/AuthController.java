package it.monko.spring.auth.controller;

import it.monko.spring.auth.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<String> registerUser(@RequestBody RegisterRequest registerRequest) {
        ...
        System.out.println("=========================================");
        System.out.println("REGISTRATION CODE FOR " + registerRequest.email() + ": " + code);
        System.out.println("=========================================");
    ...
    public ResponseEntity<String> resetPassword(@RequestBody ResetPasswordRequest request) {
        boolean okCode = verificationCodeService.verifyCode(request.getEmail(), request.getCode());
        if (!okCode) {
            return ResponseEntity.status(400).body("Invalid or expired code");
        }
