        ...
        <nav className={`navbar ${scrolled ? 'navbar--scrolled' : ''}`}>
            <div className="navbar__inner">
                ...
                <div className="navbar__actions">
                    {isAuthenticated ? (
                        <>
                            <Link to="/dashboard/projects" className="navbar__signin">Dashboard</Link>
                            <button onClick={handleLogout} className="navbar__cta" style={{ border: 'none', cursor: 'pointer', fontFamily: 'inherit', fontSize: '0.9rem' }}>Log Out</button>
                        </>
                    ) : (
                        <>
